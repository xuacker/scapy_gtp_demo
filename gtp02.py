...
from scapy.all import Ether,IP,UDP,DNS,DNSRR,sendp
...
teids = {}
# import ptvsd
# ptvsd.enable_attach("my_secret", address = ('192.168.2.97', 3000))
...
def main():
    ...
    for ts, pkt in sniffer:
        ...
        if gtp.GTP_U_Header in pkt1:
            ...
            if DNS in pkt1:
                try:
                    if (pkt1[IP][UDP][gtp.GTP_U_Header][IP][UDP].dport == 53) and (pkt1[IP][UDP][gtp.GTP_U_Header][IP][UDP][DNS].qd.qtype == 1):
